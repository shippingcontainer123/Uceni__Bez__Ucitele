...
Elektronický čítač se většinou realizuje pomocí elektronických **logických obvodů**  (především pomocí [**klopných obvodů**](../OT-15/Sekvenční%20logické%20obvody.md) ). V takovém případě mívá vstup, na který se přivede časový vstup označovaný  **C**  /  **CLK,** dále vstup nulování hodnoty –  **RESET** okamžitě vynuluje co je na čítači, vrátí do původní hodnoty, nastavení čítače na přednastavenou hodnotu -  **SET**. Na výstupech je binárně nebo v BCD (desítková v 0 a 1, jak nešetří místo, čtveřice bitů pro jednu cifru 32  00110010.

## Užití čítačů v obvodech
**_Asynchronní čítač vpřed_**
![](../../img/18.%20Asynchronní%20čítač%20vpřed.png)

Řetězec [klopných obvodů T](../OT-15/Sekvenční%20logické%20obvody.md#Klopný%20obvod%20T). Klopné obvody byly vytvořeny pomocí [obvodu JK](../OT-15/Sekvenční%20logické%20obvody.md#Klopný%20obvod%20JK) připojením obou vstupů na logickou $1$. Jednotlivé klopné obvody mění stav výstupu při každé úběžné hraně na svém hodinovém vstupu. Překlápění obvodů se tedy řídí v podstatě dvěma pravidly:
